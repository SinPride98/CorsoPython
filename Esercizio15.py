...
while scelta !=0:
    ...
    if scelta==1:
        ...
        sql="INSERT INTO Magazzino (nomeP, quantita, prezzo) VALUES (%s, %s, %s)"
        ...
        sql="UPDATE Magazzino SET quantita=%s WHERE nomeP=%s"
        ...
        sql="UPDATE Magazzino SET prezzo=%s WHERE nomeP=%s"
        valore=(prezzo,nome)
        cursor.execute(sql,valore)
        db.commit()
